...
const Home = () => {
    ...
    "@graph": [
      {
        ...
        "hasOfferCatalog": {
          ...
          "itemListElement": [
            ...
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Teeth Whitening Bathinda" } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Dental Veneers Bathinda" } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Root Canal Treatment Bathinda" } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Dental Crown and Bridge Bathinda" } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Kids Dentistry Bathinda" } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Gum Treatment Bathinda" } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Wisdom Tooth Removal Bathinda" } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Composite Bonding Bathinda" } }
          ]
        },
        "employee": [
          {
      ...
      { "@type": "Review", "itemReviewed": { "@type": "Dentist", "name": "The DentalBrace Clinic" }, "reviewRating": { "@type": "Rating", "ratingValue": "5" }, "author": { "@type": "Person", "name": "Ramesh Kumar" }, "reviewBody": "Drove from Amritsar for All-on-6 full arch implants. Dr. Ritu is simply the best implantologist in Punjab. She has done 5000+ implants and the expertise shows in every step. Complete jaw reconstruction done over 4 appointments. Life-changing results at a fair price." },
  ...
  const localBusinessSchema = {
    ...
    "@type": "Dentist",
    "name": "The DentalBrace Clinic & Implant Centre",
    "image": "https://www.thedentalbrace.com/logo.png",
    "@id": "https://thedentalbrace.com/",
