...
const Header = () => {
  ...
  const handleOpenBooking = (e, source = 'header') => {
    e.preventDefault();
    setIsMenuOpen(false);
    setActiveMegaMenu(null);
  ...
  return (
    <>
            ...
            <div className={`nav-links ${isMenuOpen ? 'open' : ''}`}>
              ...
              <div className="mobile-nav-footer">
                <a
                  ...
                  onClick={(e) => handleOpenBooking(e, 'mobile_menu_book')}
                >
                  <Calendar size={18} />
      ...
      {/* Mobile Sticky Bottom Bar — Floating Island Glassmorphism */}
      <div className="mobile-bottom-bar" role="navigation" aria-label="Mobile quick actions">
        <a href="tel:7496849392" className="bottom-bar-item bottom-bar-item--call">
          <span className="bottom-bar-icon-wrap">
            <Phone size={18} />
          </span>
          <span className="bottom-bar-label">Call</span>
        </a>

        <a
          href="https://api.whatsapp.com/send/?phone=917496849392&text=Hi%21%20I%20would%20like%20to%20book%20an%20appointment%20at%20The%20DentalBrace%20Clinic."
          className="bottom-bar-item bottom-bar-item--wa text-whatsapp"
          target="_blank"
          rel="noopener noreferrer"
        >
          <span className="bottom-bar-icon-wrap wa-icon-wrap">
          ...
          <span className="bottom-bar-label">WhatsApp</span>
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bottom-bar-item bottom-bar-item--map"
        >
          <span className="bottom-bar-icon-wrap">
            <MapPin size={18} />
          </span>
          <span className="bottom-bar-label">Directions</span>
        </a>

        <a
          href="/wedding-season-dental-offer-bathinda#wedding-consultation-form"
          className="bottom-bar-item bottom-bar-item--book primary-bg"
          onClick={(e) => handleOpenBooking(e, 'mobile_bottom_bar_book')}
          aria-label="Book Consultation"
        >
          <span className="book-pill-shine" aria-hidden="true" />
          <span className="book-pulse-ring" aria-hidden="true" />
          <span className="book-discount-tag">
            <Sparkles size={9} /> 20% OFF
          </span>
          <div className="book-btn-content">
            <Calendar size={16} className="book-btn-icon" />
            <span className="book-btn-text">Book</span>
