...
const faqs = [
  // Invisalign
  { category: 'Invisalign', q: "How much does Invisalign cost in Bathinda?", a: "The cost of Invisalign in Bathinda varies by the complexity of the case and number of aligners needed. Dr. Sandeep Kumar offers flexible EMI plans starting from competitive prices. Book a free consultation to get your personalised quote." },
  { category: 'Invisalign', q: "Is Invisalign better than traditional metal braces?", a: "Invisalign is often preferred for its near-invisibility, comfort, and removability. It allows you to eat anything, brush normally, and is virtually undetectable. Dr. Sandeep has completed 2,000+ aligner cases and will recommend the best option for your case." },
  ...
  // Implants
  { category: 'Implants', q: "Are dental implants painful?", a: "Modern dental implants are placed under local anesthesia, so you won't feel pain during the procedure. Mild soreness for 2–3 days after is normal. Dr. Ritu Saneja has placed 500+ implants with an exceptional comfort record." },
