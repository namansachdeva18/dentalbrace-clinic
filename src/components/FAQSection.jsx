...
const faqs = [
  ...
  { category: 'Invisalign', q: "Is Invisalign better than traditional metal braces?", a: "Invisalign is often preferred for its near-invisibility, comfort, and removability. It allows you to eat anything, brush normally, and is virtually undetectable. Dr. Sandeep has completed 3,000+ aligner cases and will recommend the best option for your case." },
  ...
  // Implants
  { category: 'Implants', q: "Are dental implants painful?", a: "Modern dental implants are placed under local anesthesia, so you won't feel pain during the procedure. Mild soreness for 2–3 days after is normal. Dr. Ritu Saneja has placed 3,000+ implants with an exceptional comfort record." },
