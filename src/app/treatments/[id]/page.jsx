...
const treatmentMeta = {
  'invisalign': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/invisalign',
    ogImage: 'https://www.thedentalbrace.com/dr-sandeep.jpg',
  },
  'dental-implants': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/dental-implants',
    ogImage: 'https://www.thedentalbrace.com/dr-ritu.jpg',
  },
  'all-on-4': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/all-on-4',
    ogImage: 'https://www.thedentalbrace.com/dr-ritu.jpg',
  },
  'smile-makeover': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/smile-makeover',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'braces': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/braces',
    ogImage: 'https://www.thedentalbrace.com/dr-sandeep.jpg',
  },
  'veneers': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/veneers',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'teeth-whitening': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/teeth-whitening',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'root-canal': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/root-canal',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'dental-crown-bridge': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/dental-crown-bridge',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'dentofacial-orthopedics': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/dentofacial-orthopedics',
    ogImage: 'https://www.thedentalbrace.com/dr-sandeep.jpg',
  },
  'kids-dentistry': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/kids-dentistry',
    ogImage: 'https://www.thedentalbrace.com/dr-sandeep.jpg',
  },
  'gum-treatment': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/gum-treatment',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'wisdom-tooth-removal': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/wisdom-tooth-removal',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'composite-bonding': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/composite-bonding',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'digital-dentistry': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/digital-dentistry',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'maxillofacial-prosthetics': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/maxillofacial-prosthetics',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  'smile-designing': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/smile-designing',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
  '3d-intraoral-scanner': {
    ...
    canonical: 'https://www.thedentalbrace.com/treatments/3d-intraoral-scanner',
    ogImage: 'https://www.thedentalbrace.com/hero-image.jpg',
  },
};
...
export async function generateMetadata({ params }) {
  ...
  const canonical = meta?.canonical || `https://www.thedentalbrace.com/treatments/${slug}`;
  const ogImage = meta?.ogImage || 'https://www.thedentalbrace.com/hero-image.jpg';
