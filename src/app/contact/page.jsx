              ...
              <form className="modern-form" onSubmit={handleSubmit}>
                <div className="form-row">
                  ...
                  <div className="input-group">
                    ...
                    <input type="tel" id="phone" placeholder="+91 00000-00000" value={formData.phone} onChange={(e) => setFormData({...formData, phone: e.target.value.replace(/[^0-9+]/g, '')})} required />
                  </div>
                </div>
      ...
      <section className="map-section py-20 bg-cream">
        <div className="container">
          <div className="text-center mb-10">
            ...
            <p className="text-secondary mt-2">Conveniently located at 196, Bibi Wala Rd with free patient parking.</p>
          </div>
